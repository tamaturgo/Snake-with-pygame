...
# Apple Controller
point = pygame.image.load("assets/images/lais.dib_.png")
...
while game_cycle:
    ...
    if credits_controller:
        ...
        initial_credits_text = game_girl_20.render("Eating Sound\n By InspectorJ", True, (255, 255, 255))
        initial_credits_text_rect = (120, 330)
        screen.blit(initial_credits_text, initial_credits_text_rect)
    ...
    if game_controller:
        ...
        if game_over:
            ...
            record_score_text = game_girl_32.render("Best score: " + '%03d'
                                                    % persistence.consult_score(),
                                                    True, (255, 255, 255))
            record_score_text_rect = record_score_text.get_rect()
